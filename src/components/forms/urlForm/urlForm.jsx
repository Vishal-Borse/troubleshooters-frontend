...
const UrlForm = () => {
  ...
  const checkUrl = async (e) => {
    ...
    console.log(json);
    if (json.success) {
      document.getElementById("verifiedMsg").innerText = `This Url is verified and secure`;
    } else {
      document.getElementById("verifiedMsg").innerText = `This Url is not secure or does not exist`;
    }
  };
